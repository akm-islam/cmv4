...
class App extends Component {
    ...
    componentDidUpdate() {
        ...
        .attr("add_keywords",function(d,i){
            ...
            if(i==0){d3.select(this).selectAll(".keyword_Text").data(keywords).join("text").attr("x", (d,i)=>(rect_width*2)+(rect_width*i)+rect_width/2).attr('text-anchor','middle').attr("class", "keyword_Text").attr('dominant-baseline',"middle").attr("y",-15).text((keyword)=>keyword).attr("fill","#1c1c1c").style("text-transform","capitalize").attr("font-size",14)}
